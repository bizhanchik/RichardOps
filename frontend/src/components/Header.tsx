    ...
    <div className={`sticky inset-x-0 py-4 top-0 z-50 w-full ${className}`}>
      <div className="w-full grid place-items-center">
        <div className={`transition-all duration-300 ease-out ${
          visible ? 'max-w-4xl' : 'max-w-[1632px]'
        } w-full`}>
          <header 
          ...
          >
            <div className={`flex items-center transition-all duration-200 ${
              visible ? 'justify-between px-4' : 'justify-between'
            }`}>
              {/* Logo */}
              ...
              <nav className={`flex items-center transition-spacing duration-200 ${
                ...
                <button className={`bg-emerald-600 text-white rounded-lg font-medium hover:bg-emerald-700 transition-colors duration-200 ${
